...
const cfg = {
  ...
  hiddenColumns: {
    ...
    default: [],
    items: {type: 'string'},
    description: 'These columns will not be visible. Right-click on header to see options, or use commands panel (`textual-velocity:toggle-column-name-of-column`)'
  },
  defaultExt: {
