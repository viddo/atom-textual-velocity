...
export function changeHiddenColumns (hiddenColumns: string[]): ChangedHiddenColumns {
  return {
...
export function editCellSave (editCellName: string, value: string): EditCellSave {
  return {
    type: EDIT_CELL_SAVE,
    editCellName,
    value
