...
export default class ViewCtrl {
  ...
  constructor (view: ViewType) {
    ...
    this.abortEditCellStream = view.abortEditCellStream
    this.clickedCellStream = view.clickedCellStream
    this.dblClickedCellStream = view.dblClickedCellStream
    this.saveEditedCellContentStream = view.saveEditedCellContentStream
