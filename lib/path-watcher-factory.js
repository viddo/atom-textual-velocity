  ...
  watch (notesCache: Object, notesPath: NotesPathType, filter: NotesFileFilterType): PathWatcherType {
    ...
    const sifterP = Bacon
      .update(
        ...
        [newFileS, this._fieldsP, this._fileReadersP], (sifter: Sifter, file: FileType, fields: Array<FieldType>, fileReaders: Array<FileReaderType>) => {
    ...
    return {
      ...
      newFilenameS: newFileS.map('.filename'),
      sifterP: sifterP,
