...
describe("previewEditor", function() {
  it("should behave as expected", async function() {
    ...
    const content = "baz\nqux\nfoobar\ntrololol";
    await preview.openPreview("/notes/bar.md", content, /ba/);
    ...
    // text changed; should not trigger anything
    let openResult;
    ...
    // cursor move but no text change, should destroy preview and open normal editor in its place
    preview.cursorMoved({
      textChanged: false,
