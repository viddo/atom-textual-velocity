...
import selectedNoteReducer from "./selected-note";
...
describe("reducers/selected-note", () => {
  let action: Action;
  let dir: string;
  let nextSifterResult: SearchResult<$Keys<Notes>>;
  ...
  beforeEach(function() {
    ...
    state = selectedNoteReducer(undefined, A.search(""), dir, nextSifterResult);
    selectedNote = {
      filename: "foo",
      index: 42
    };
