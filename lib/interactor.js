  ...
  constructor (viewCtrl: ViewCtrlType, pathWatcherFactory: PathWatcherFactoryType, service: ServiceType) {
    ...
    this.selectedFilenameS = Bacon
      .update(undefined,
        ...
        [viewCtrl.keyUpS, this.notesPathP, itemsP], (oldFilename, _, notesPath, items) => {
        ...
        [viewCtrl.keyDownS, this.notesPathP, itemsP], (oldFilename, _, notesPath, items) => {
        ...
        [resetS], undefined,
        [searchS], undefined,
        [this.notesP.changes(), this.saveEditedCellContentS.toProperty()], (oldFilename, notes, lastEditedCellContent) => {
          return Object
            .keys(notes)
            .find(filename => filename === oldFilename || filename === lastEditedCellContent)
        })
      .changes()
      .skipDuplicates()
