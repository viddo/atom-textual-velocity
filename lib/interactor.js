...
export default class Interactor {
  ...
  /**
   * @param {Object} req - request object from view-ctrl
  ...
  startSession (req) {
    ...
    const initialScanDoneProp = this._pathWatcher.initialScanDoneProp()
    this._logger.logPathScan({filesProp: filesProp, initialScanDoneProp: initialScanDoneProp})
