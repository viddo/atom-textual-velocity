...
export default class Interactor {
  ...
  startSession (req) {
    ...
    this._disposeSearchResults = Bacon
      .combineTemplate({
        ...
        sifterResults: this._sifterResultsProp,
  ...
  @memoize get _sifterResultsProp () {
  ...
  @memoize get _selectedIndexProp () {
    return Bacon
      .update(undefined,
        ...
        [this._selectByOffsetBus, this._sifterResultsProp.map('.total')], (oldIndex, offset, itemsCount) => {
          return offset > 0
