...
export default {
  ...
  startSession () {
    ...
    this.stopSessionCmd = atom.commands.add('atom-workspace', 'textualVelocity:stop-session', () => {
      this.stopSession()
      this.startSessionCmd = atom.commands.add('atom-workspace', 'textualVelocity:start-session', () => {
        this.startSession()
      })
    })
    ...
    this.toggleCmd = atom.commands.add('atom-workspace', 'textualVelocity:toggle-atom-window', () => {
      if (this.panel) {
