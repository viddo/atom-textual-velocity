...
let disposables, columns, fileReaders, fileWriters, noteFields, service, session, sessionCmds, startSessionCmd
...
function startSession () {
  ...
  session = new Session()
  session.start(columns, fileReaders, fileWriters, noteFields)
