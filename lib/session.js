...
export default class Session {
  ...
  constructor (columns: Columns, fileReaders: FileReaders, notes: Notes, noteFields: NoteFields) {
    ...
    const middlewares = applyMiddleware(thunk, makeEpicMiddleware(fileReaders))
