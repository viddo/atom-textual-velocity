...
class Panel {
  ...
  constructor (project) {
    ...
    this.disposables = new DisposableValues(
      ...
      reactPanel.selectedItemProp
        ...
        .onValue(selectedItem => {
          if (selectedItem) {
            ...
            this._previewEditor.getPath = R.always(Path.join(selectedItem.projectPath, selectedItem.relPath))
      ...
      Bacon.when(
        [openFileStream, reactPanel.selectedItemProp, reactPanel.searchProp], (_, selectedItem, searchStr) => {
          if (selectedItem) {
