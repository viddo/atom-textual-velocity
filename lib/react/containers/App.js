...
import newVisibleRowsSelector from "../../reselectors/visibleRowsSelector";
...
export default function newApp(columns: IColumns) {
  const visibleRowsSelector = newVisibleRowsSelector(columns);
