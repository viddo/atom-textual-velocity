...
export default class Main extends React.Component {
  ...
  render () {
    ...
    return (
      <div className='textual-velocity'>
        <Search query={this.props.queryOriginal}
                        ...
                        if (typeof cell.editCellStr === 'string') {
                          return (
                            <EditCellStr key={i} initialVal={cell.editCellStr}
                              save={str => actions.editCellSave(this.props.editCellName, str)}
                              abort={() => actions.editCellAbort()} />
                          )
                        } else {
                          return (
                            <Cell key={i} cell={cell} onDoubleClick={() => {
  ...
  componentDidMount () {
    const changeRowHeightSubscription = Observable
