...
export default class LoadingProgress extends React.Component {
  ...
  _onClick () {
    atom.notifications.addInfo('Textual Velocity', {
      description: 'Reading files to populate searchable note fields. It\'s only necessary for the first run of your notes path, after that it gets cached (until you change notes path or clear the cache).',
      dismissable: true
    })
  }
}
