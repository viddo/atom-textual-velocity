...
export default React.createClass({
  ...
  propTypes: {
    ...
    totalProp: React.PropTypes.object,
  ...
  componentWillMount () {
    ...
    this.onStreamsValues(
      bodyHeightProp, scrollTopProp, searchProp, selectedItemProp, this.props.totalProp, this.props.itemsProp,
      (bodyHeight, scrollTop, searchStr, selectedItem, total, items) => {
        this.setState({
          bodyHeight: bodyHeight,
          scrollTop: scrollTop,
          itemsCount: total,
          visibleItems: items,
          reverseStripes: calcPagination(scrollTop) % 2 === 0,
