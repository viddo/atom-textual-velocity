...
export default React.createClass({
  ...
  componentWillMount () {
    ...
    this.selectedItemProp = Bacon
      .combineWith(this.props.resultsProp, selectedIndexProp.filter(R.is(Number)), (r, selectedIndex) => {
        return r.items[selectedIndex - r.paginationOffset]
      })
      .filter(R.is(Object))
  },
