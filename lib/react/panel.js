...
export default React.createClass({
  ...
  propTypes: {
    ...
    closePreviewEditorStream: React.PropTypes.object
  },
  ...
  componentWillMount () {
    ...
    const panelHeightBus = new Bacon.Bus()
    ...
    const panelHeightProp = panelHeightBus.skipDuplicates().filter(newHeight => newHeight > 0).toProperty(100)
    ...
    const selectedProp = Bacon
      .update(
        ...
        [this.props.closePreviewEditorStream], R.always({}),
    ...
    this._panelHeightBus = panelHeightBus
    ...
    this.panelHeightProp = panelHeightProp
