...
export default React.createClass({
  ...
  componentWillMount () {
    ...
    let selectedIndexProp = Bacon.update(
      ...
      [selectPrevStream, this.props.resultsProp], (selectedIndex, _, r) => indices.prev(r.total, selectedIndex),
      [selectNextStream, this.props.resultsProp], (selectedIndex, _, r) => indices.next(r.total, selectedIndex)
    ).skipDuplicates()
    ...
    this.selectedItemProp = Bacon
      .combineWith(this.props.resultsProp, selectedIndexProp, (r, selectedIndex) => r.items[selectedIndex - r.offset])
      .filter(R.is(Object))
  },
