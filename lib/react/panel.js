...
export default React.createClass({
  ...
  componentWillMount () {
    ...
    let selectedIndexProp = Bacon.update(
      ...
      [selectPrevStream, this.props.resultsProp], (currentIndex, _, r) => indices.prev(r.total, currentIndex),
      [selectNextStream, this.props.resultsProp], (currentIndex, _, r) => indices.next(r.total, currentIndex)
    ).skipDuplicates()
