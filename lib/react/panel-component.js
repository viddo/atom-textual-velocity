...
import Tags from './cells/tags-component'
      ...
      columns: [
        {
          ...
          title: 'Tags',
          width: 20,
          createCell: file => <Tags key='tags' tags={file.tags} />
        }, {
          title: 'Date modified',
          width: 15,
  ...
  render () {
    return (
      <div className='textual-velocity'>
        <div className='textual-velocity-loader' style={{ display: this.state.isLoadingFiles ? 'block' : 'none' }}>
        ...
        <Search
          ...
          />
        <div className='textual-velocity-items'>
