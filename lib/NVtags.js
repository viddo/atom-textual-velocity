...
unsupportedError = new Error("skip");
...
//
//   const testNVtagsPath = require("path").join(
//     require("os").tmpdir(),
//     "verify-nv-tags" + process.hrtime().toString()
//   );
//
//   // Filesystem might not support xattrs, verify before continuing
//   fs.writeFileSync(testNVtagsPath, "");
//   xattr.setSync(testNVtagsPath, XATTR_KEY, "test writing xattrs");
//   fs.unlinkSync(testNVtagsPath);
// } catch (error) {
