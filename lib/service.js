...
export default class Service {
  ...
  addField (field: FieldType) {
    ...
    if (typeof field.filePropName !== 'string') return logError('field.filePropName string is required', field)
  ...
  addFileReader (fileReader: FileReaderType) {
    ...
    if (typeof fileReader.filePropName !== 'string') return logError('fileReader.filePropName string is required', fileReader)
