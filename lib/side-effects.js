...
export default class SideEffects {
  ...
  constructor (panel: Atom$Panel, view: ViewType, presenter: PresenterType, service: ServiceType) {
    ...
    this._disposables = new Disposables(
      ...
      this._previewSelectedPath(presenter.selectedPathS, presenter.selectedContentP),
  ...
  _previewSelectedPath (selectedPathS: Bacon.Stream, selectedContentP: Bacon.Stream) {
