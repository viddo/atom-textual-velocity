...
export default class Behavior {
  ...
  constructor ({domNode, panelHeightStream, isLoadingFilesProp, filesProp, resultsProp, focusOnSearchStream, deselectStream}) {
    ...
    const keyDownBus = keyDownBus || new Bacon.Bus()
    keyDownBus.doLog('[appBehavior keydownBus]')
    ...
    this.createFileStream = Bacon
      ...
      .filter('.length')
      .doLog('[appBehavior.createFileStream]')
