...
import paginationSelector from "../../lib/reselectors/paginationSelector";

import type { Pagination } from "../../lib/reselectors/paginationSelector";
import type { State } from "../../flow-types/State";

describe("reselectors/paginationSelector", () => {
  let state: State;
