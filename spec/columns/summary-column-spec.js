  ...
  describe('.cellContent', function () {
    ...
    describe('when there is no query applied', function () {
      ...
      it('should return a kind of AST from which a DOM can be created', function () {
        ...
        expect(cellContent[2]).toEqual(jasmine.any(String), 'should be a separator between title and file content preview')
        expect(cellContent[3]).toEqual(jasmine.any(Object), 'file content preview')
