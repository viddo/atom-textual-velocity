...
import * as showWarningNotificationImport from "../../lib/showWarningNotification";
import renameNoteEpic from "../../lib/epics/renameNoteEpic";
...
describe("epics/renameNoteEpic", () => {
  ...
  beforeEach(() => {
    ...
    epicMiddleware.run(renameNoteEpic);
    spyOn(fs, "rename");
  });
