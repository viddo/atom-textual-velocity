...
import focusOnSearchWhenClosingLastEditorEpic from "../../lib/epics/focus-on-search-when-closing-last-editor";
import * as A from "../../lib/action-creators";
import { beforeEach } from "../_async-spec-helpers";

describe("epics/focus-on-search-when-closing-last-editor", () => {
  let store;
  let cmdSpy;
