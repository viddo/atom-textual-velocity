...
import focusOnSearchWhenClosingLastEditorEpic from "../../lib/epics/focusOnSearchWhenClosingLastEditorEpic";
...
describe("epics/focusOnSearchWhenClosingLastEditorEpic", () => {
  ...
  beforeEach(async () => {
    ...
    store = mockStore();
    epicMiddleware.run(focusOnSearchWhenClosingLastEditorEpic);
